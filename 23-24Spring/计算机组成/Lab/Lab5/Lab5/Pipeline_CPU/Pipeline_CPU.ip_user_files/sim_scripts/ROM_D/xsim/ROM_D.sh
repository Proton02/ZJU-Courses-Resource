...
#
# Script generated by Vivado on Fri Jun 14 19:07:23 +0800 2024
...
# script info
echo -e "ROM_D.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM_D xil_defaultlib.ROM_D xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Code/Xilinx/Vivado/2023.2/data/xsim"
  fi
